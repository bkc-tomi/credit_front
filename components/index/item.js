...
export default function Item({ type, id="", propsValue="", func=null, cls="" }) {
    ...
    if (flg) {
        ...
        return (
            <div className="flex justify-start items-center">
                { input }
                <Button id={ `${ id }_submit` } func={ () => handleSave() } cls="mr-2" disabled={ false }>
                ...
                <Button func={() => handleFlg() } disabled={ false }>
